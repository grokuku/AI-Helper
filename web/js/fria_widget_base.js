/**
 * FRIA Widget Base - Shared infrastructure for ComfyUI custom widgets.
 *
 * This module provides common utilities (waitForApp, registerWidget) to reduce
 * duplication across fria_*_widget.js files. Individual widget files should
 ...
 *
 * Depends on: fria_shared.js (for FRIA namespace / getApiKey)
 */
(function() {
    "use strict";
     ...
     */
    FRIA.waitForApp = function(callback, opts) {
        opts = opts || {};
        ...
        const check = setInterval(() => {
            ...
            if (app && app.graph) {
                ...
                clearInterval(check);
                console.warn("[FRIA] App not ready after", maxAttempts, "attempts");
     ...
     */
    FRIA.registerWidget = function(nodeType, config) {
        config = config || {};
