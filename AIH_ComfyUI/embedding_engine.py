...
# Import robuste de store.py (même pattern que sync_engine.py) :
# - Runtime ComfyUI : `from AIH_ComfyUI import store` fonctionne.
# - Tests / import direct : chargement par chemin absolu sans exécuter __init__.
try:
