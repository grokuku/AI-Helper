...
Imports robustes : comme sync_engine.py, le module charge store.py par
package dans le runtime ComfyUI (le package AIH_ComfyUI est pré-enregistré
dans sys.modules par _load_module, donc `from AIH_ComfyUI import store`
n'exécute PAS le __init__.py mort), sinon par chemin absolu via importlib
(tests / import direct hors ComfyUI).
"""
